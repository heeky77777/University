...
<html>
    ...
    <style>
        .bg_login{
            background: url(${pageContext.request.contextPath}/resources/img/twice.png) no-repeat center top;
        ...
        .login-right h2.title{
            /*(background: url(/images/sm/login_title.png) no-repeat 0 1px;*/
            padding-bottom: 15px;
            height: 50px;
