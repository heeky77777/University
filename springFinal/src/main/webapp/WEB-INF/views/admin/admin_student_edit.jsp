...
<div class="container-fluid">
	<div class="form">
		<div class="offset-md-4 col-md-4">
			<br><br>
			<h1 class="form-group" style="text-align: center"> 학생 정보 수정 </h1><hr><br><br>

    		<form action="admin_student_edit" method="post">
...
<!-- 		    </div>   -->
		    ...
		    <div class="form-group">    
		    	<label>학년</label>  
		    	<input class="form-control" type="text" name="student_grade" value="${studentDto.student_grade}">
		    </div>
		    <div  class="form-group">	
		       	<label>학과</label> 
		       	<input class="form-control" type="text" name="major_no" value="${studentDto.major_no}">		    	
		   </div>
		   <div class="form-group">
		    	<label>학기</label> 
		    	<input class="form-control" type="text" name="semester_no" value="${studentDto.semester_no}">		    		
		   </div>
		   <div class="form-group">
		    	<label>학적상태</label> 
		    	<input class="form-control" type="text" name="student_state" value="${studentDto.student_state}">		    		
		   </div>	
		   <div class="form-group">
		   		<label>성별</label>
		   ...
		   <div class="form-group">
		    ...
		    <div class="form-group">
		    	<a class="form-control btn btn-primary btn-block" href="${pageContext.request.contextPath}/member/main?admin_no=${userinfo.admin_no}" style="color:white">홈으로</a>		    	
		    </div>	
		    </form>		    
    	</div>
    </div>
